...
def train(options, data, n_gpus, tf_save_dir, tf_log_dir,
    ...
    with tf.device('/cpu:0'):
        ...
        histogram_summaries.extend(
            summary_gradient_updates(grads, optimizer, learning_rate))
        ...
        for batch_no, batch in enumerate(data_gen, start=1):
            ...
            if hvd.rank() == 0:
                ...
                if batch_no % 100 == 0:
                    ...
                    print('Step = %6i Total Time = %15.3f Completed Batches = %5.4f% Throughput = %10.1f Train Perplexity = %6.3f LR = %6.4e' %
